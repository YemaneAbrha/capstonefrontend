    ...
    <v-row align="center" justify="center">
      ...
      >
        ...
        <template v-slot:item.actions="{ item }">
          <v-icon @click="approveTenant(item)" color="success">mdi-check</v-icon>
          <v-icon small @click="declineTenant(item)" color="error">mdi-delete</v-icon>
        </template>
...
export default {
  ...
  methods: {
    ...
    declineTenant(item) {
      // console.log(
      //   "sdjksddsjds djsdkjaskdjaksjdkasjdas _____________________------"
      // );
