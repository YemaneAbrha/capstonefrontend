<template>
  <v-sheet>
    ...
    <v-row align="center" justify="center">
      <v-container ma-5>
        <h3 class="text-center display-3 hidden-xs-only">Pending Fees</h3>
        <h3 class="text-center display-1 hidden-sm-and-up">Pending Fees</h3>
      </v-container>
    </v-row>
    <v-row align="center" justify="center">
      <!-- Start here -->
      <v-data-table :headers="headers" :items="$store.state.pendingBill" class="elevation-1">
        <template v-slot:top>
          <v-toolbar flat>
    ...
    <v-row align="center" justify="center">
      <!-- Start here -->
      <v-data-table :headers="headers" :items="$store.state.paidFee" class="elevation-1">
        <template v-slot:top>
          <v-toolbar flat>
            <v-divider class="mx-4" inset vertical></v-divider>
            <v-spacer></v-spacer>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      // } else {
      //   console.log("Error the index of item not found");
